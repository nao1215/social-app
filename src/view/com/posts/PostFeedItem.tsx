...
/**
 * PostFeedItem - 投稿フィードアイテムコンポーネント
 *
 * 【主な機能】
 * - フィード内の個別投稿表示
 * - リポスト・返信・引用投稿の表示
 * - モデレーション・コンテンツフィルタリング対応
 * - 投稿メタデータ（時刻・リアクション数など）表示
 *
 * 【レガシー情報】
 * - AT Protocolの投稿データ構造対応
 * - 複雑な投稿種別判定ロジック
 * - シャドウ・キャッシュシステム統合
 *
 * 【アーキテクチャ】
 * - Reasonベースの投稿種別分岐処理
 * - Embedコンポーネントでの添付コンテンツ表示
 * - モデレーション決定に基づくコンテンツ隠し
 * - フィードフィードバック・ピン留め統合
 *
 * @param props - 投稿データ、レンダリングオプション、コールバック群
 * @returns JSX要素 - 投稿フィードアイテム
 */
